                        ...
                        "<div class='control-group'>",
                          ...
                          "<div class='controls'>",
                            "<label for='inspiration_control_type_phone"+new_location_id+"' class='checkbox inline'>",
                               "<input type='radio' value='Telefonická' name='inspiration[inspiration_address_attributes][location"+new_location_id+"][control_type]' id='inspiration_control_type_phone"+new_location_id+"' checked='checked'>",
                                  "Telefonická",
                            "</label>",
                            "<label for='inspiration_control_type_terain"+new_location_id+"' class='checkbox inline'>",
                               "<input type='radio' value='Terénna' name='inspiration[inspiration_address_attributes][location"+new_location_id+"][control_type]' id='inspiration_control_type_terain"+new_location_id+"' checked=''>",
                                  "Terénna",
                            "</label>",
                          "</div>",
                        "</div>",
